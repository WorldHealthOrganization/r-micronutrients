...
#' @param mothers_education (Optional) a vector indicating the education level of mothers, encoded numerically as 0="None", 1="Primary education", 2="Secondary education", 3="Higher education" are accepted.
#' @param area (Optional) integer values (1 = "Urban" and 2 = "Rural") or a character vector indicating the type of residence such as "Rural" or "Urban" are accepted.
